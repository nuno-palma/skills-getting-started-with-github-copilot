...
activities = {
    ...
    "Soccer Team": {
        "description": "Team soccer practice and local match play",
    ...
    "Drama Club": {
        ...
        "max_participants": 20,
        "participants": ["sam@mergington.edu", "hannah@mergington.edu"]
    },
    "Science Olympiad": {
    ...
    "Math Circle": {
        "description": "Solve challenging math problems and explore advanced concepts",
